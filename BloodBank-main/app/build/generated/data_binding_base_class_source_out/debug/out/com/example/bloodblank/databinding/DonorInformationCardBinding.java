...
public final class DonorInformationCardBinding implements ViewBinding {
  @NonNull
  ...
  private DonorInformationCardBinding(@NonNull CardView rootView,
  ...
  @NonNull
  public static DonorInformationCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DonorInformationCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.donor_information_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DonorInformationCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DonorInformationCardBinding((CardView) rootView, profilePhotoCardView,
