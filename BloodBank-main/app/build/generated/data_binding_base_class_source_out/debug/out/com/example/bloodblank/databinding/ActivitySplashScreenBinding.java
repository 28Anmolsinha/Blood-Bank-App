...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView logoImageView, @NonNull TextView splashTextView) {
    this.rootView = rootView;
    this.logoImageView = logoImageView;
    this.splashTextView = splashTextView;
  }
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.splashTextView;
      TextView splashTextView = ViewBindings.findChildViewById(rootView, id);
      if (splashTextView == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, logoImageView,
          splashTextView);
    }
