...
public class DonationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentView = inflater.inflate(R.layout.fragment_donation, container, false);
    ...
    private void submitButtonClicked() {
        ...
        ref2.get().addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
            ...
            public void onSuccess(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(requireActivity(), "Thanks for the donation!", Toast.LENGTH_SHORT).show();
